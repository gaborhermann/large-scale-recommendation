package hu.sztaki.ilab.mf.offline
...
/** Stochastic gradient descent algorithm to calculate a matrix factorization.
  *
  ...
  * [[hu.sztaki.ilab.mf.offline.MatrixFactorization.Blocks]]).
  *
  ...
  * (set at [[hu.sztaki.ilab.mf.offline.MatrixFactorization.Iterations]])
  ...
  * =Parameters=
  *
  *  - [[hu.sztaki.ilab.mf.offline.MatrixFactorization.NumFactors]]:
  *  The number of latent factors. It is the dimension of the calculated user and item vectors.
  *  (Default value: '''10''')
  *
  *  - [[hu.sztaki.ilab.mf.offline.MatrixFactorization.Lambda]]:
  ...
  *
  *  - [[hu.sztaki.ilab.mf.offline.MatrixFactorization.TemporaryPath]]:
  ...
  *  (Default value: '''None''')
  */
class DSGDforMF extends MatrixFactorization[DSGDforMF] {
  ...
  /** Sets the initial learning rate for the algorithm.
    ...
    * @return
    */
  def setLearningRate(learningRate: Double): DSGDforMF = {
...
object DSGDforMF {
  ...
  /** Calculates the matrix factorization for the given ratings. A rating is defined as
    ...
    */
  implicit val fitSGD = new FitOperation[DSGDforMF, (Int, Int, Double)] {
    override def fit(
                      instance: DSGDforMF,
